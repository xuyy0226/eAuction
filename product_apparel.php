            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-4">
                        <h3>Category</h3>
                        <div class="thumbnail">
                            <img src="img/apparel_overwatch.jpg" alt="">
                            <center>
                                <div class="caption">
                                    <h3>Overwatch</h3>
                                    <p><a href="category.php?type_id=4" role="button" class="btn btn-primary btn-block">Check it out!</a></p>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <br><br><br>
                        <div class="thumbnail">
                            <img src="img/apparel_starcraft.jpg" alt="">
                            <center>
                                <div class="caption">
                                    <div class="caption">
                                        <h3>Starcraft</h3>
                                        <p><a href="category.php?type_id=5" role="button" class="btn btn-primary btn-block">Check it out!</a></p>
                                    </div>
                                </div>
                            </center>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <br><br><br>
                        <div class="thumbnail">
                            <img src="img/apparel_world.jpg" alt="">
                            <center>
                                <div class="caption">
                                    <h3>World of Warcraft</h3>
                                    <p><a href="category.php?type_id=6" role="button" class="btn btn-primary btn-block">Check it out!</a></p>
